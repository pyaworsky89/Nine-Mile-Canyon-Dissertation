...
plot(mod1$gam,select=1,shade=T,ylab="Probs Cul",xlab="SPD",shift= ilink(coef(mod1$gam)[1]))
plot(mod1$gam,select=2,shade=T,ylab="Probs Cul",xlab="Avg Precip",shift= ilink(coef(mod1$gam)[1]))
...
plot(mod1$gam,select=3,shade=T,ylab="Num Stor",xlab="GDE",ylim=c(0,0.05),shift=coef(mod1$gam)[1]);box()
...
plot(mod1$gam,select=3,shade=T,ylab="Viewshed of Floodplain",xlab="GDE",shift= coef(mod1$gam)[1],ylim=c(0,30));box() #this plot is close but not exact
###
hist(residuals(mod1$lme, 
              type="normalized"),
    main=NA,
...
plot(mod1$gam,select=3,shade=T,ylab="Elevation above Floodplain",xlab="GDE",shift= coef(mod1$gam)[1],ylim=c(0,0.45));box() #this plot is close but not exact...
