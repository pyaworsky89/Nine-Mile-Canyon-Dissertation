...
invgde<-1-df$meanGDE
plot(numstor~invgde,df)
abline(lm(numstor~invgde,df))
...
plot(mod1$gam,select=3,shade=T,residuals=T,ylab="VS",xlab="GDE",shift= coef(mod1$gam)[1]) #this plot is close but not exact

invgde<-1-df$meanGDE
plot(VS~invgde,df)
abline(lm(VS~invgde,df))
...
plot(mod1$gam,select=3,shade=T,residuals=T,ylab="Elev",xlab="GDE",shift= coef(mod1$gam)[1]) #this plot is close but not exact...

#inverse plot 
invgde<-1-df$meanGDE
plot(elevfp~invgde,df)
abline(lm(elevfp~invgde,df))
```
